...
with open(genome, "r") as fasta_file:
    ...
    sequence = "".join([line.strip() for line in fasta_file])  # Die restlichen Zeilen einlesen
...
print(sequence[left:candidate-1], " ", sequence[candidate-1], " ", sequence[candidate:right])