...
rule unzip_untreated_fastqs:
    input:
        "resources/Illumina_pe/untreated/dummy/dummy_{no}.fastq.gz",
    output:
        "resources/Illumina_pe/untreated/dummy/dummy_{no}.fastq",
    log:
        "logs/ceta_benchmark/unzip_untreated_fastqs_{no}.log",
    shell:
        """
